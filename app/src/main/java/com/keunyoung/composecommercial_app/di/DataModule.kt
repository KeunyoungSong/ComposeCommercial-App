...
import com.keunyoung.data.repository.PurchaseHistoryRepositoryImpl
...
interface DataModule {
	...
	@Binds
	@Singleton
	fun bindPurchaseRepository(purchaseHistoryRepositoryImpl: PurchaseHistoryRepositoryImpl) : PurchaseHistoryRepository
}